...
public final class Table {
    ...
    private Table() {
        ...
        this.gameFrame = new JFrame("BlackWidow Xadrez");
    ...
    void handleMoveMade(final Move move,
        ...
        if (getGameBoard().currentPlayer().isInCheckMate()) {
            String message = "Jogador " + getGameBoard().currentPlayer() + " está em cheque-mate!";
    ...
    void handleAIThinking() {
        AIThinkTank thinkTank = new AIThinkTank(null, this.eventManager);
        thinkTank.execute();
    }
    ...
    private static class AIThinkTank extends SwingWorker<Move, String> {
        ...
        protected Move doInBackground() {
            final Move bestMove;
            final Move bookMove = (Table.get().getUseBook() && persistence != null)
